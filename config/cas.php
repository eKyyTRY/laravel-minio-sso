...
return [
    ...
    */
    'cas_hostname' => env('CAS_HOSTNAME', '192.168.150.40'),
    ...
    */
    'cas_real_hosts' => env('CAS_REAL_HOSTS', '192.168.150.40'),
    ...
    */
    ...
    | Empty is fine
    */
    'cas_login_url' => env('CAS_LOGIN_URL', 'https://192.168.150.40:8443/cas/login'),
